...
record = {}; 
% structure of record:
%   * record_first{ round } { sequence id } { player } = desired sequence
...
show_result(record, 1, "strategy", bids_1, [5, 6], {'b', 'g'}, "player 1's mixed strategy, " + substring); 
show_result(record, 2, "frequency", bids_2, [4, 5], {[0.9290 0.6940 0.1250], 'b'}, "player 2's bid frequency, " + substring); 
show_result(record, 2, "strategy", bids_2, [4, 5], {[0.9290 0.6940 0.1250], 'b'}, "player 2's mixed strategy, " + substring); 
